...
function resetBanner() {
  ...
  gsap.set('#taca', { x: -600, autoAlpha: 1 });
...
function startAnimation() {
  ...
  a += 0.5;
  gsap.to('#dulce', { scale: 1.2, x: -70, y: -5, delay: a });
  gsap.to('#mango', { scale: 1.2, x: -70, y: -5, delay: a });
  gsap.to('#cookies', { scale: 1.2, x: -70, y: -5, delay: a });
  gsap.to('#vanilla', { scale: 1.2, x: -70, y: -5, delay: a });
  gsap.to('#strawberry', { scale: 1.2, x: -70, y: -5, delay: a });
