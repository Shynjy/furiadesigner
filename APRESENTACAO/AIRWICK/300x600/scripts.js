...
function resetBanner() {
  ...
  gsap.set("#copy1", { scale: 1.2, autoAlpha: 0 });
  gsap.set("#copy2", { scale: 1.2, autoAlpha: 0 });
  gsap.set("#copy3", { y: -58, autoAlpha: 0 });

  gsap.set("#legal1", { autoAlpha: 0 });
  gsap.set("#legal2", { autoAlpha: 0 });

  gsap.set("#moldura", { autoAlpha: 1 });
...
function startAnimation() {
  ...
  a += 0.5;
  gsap.to("#logo", 0.75, { y: 58, ease: Quad.easeInOut, delay: a, });
  gsap.to("#moldura", 0.75, { y: 58, ease: Quad.easeInOut, delay: a, });
  
  gsap.to("#copy3", 0.75, { y: 0, autoAlpha: 1, ease: Quad.easeInOut, delay: a, });
